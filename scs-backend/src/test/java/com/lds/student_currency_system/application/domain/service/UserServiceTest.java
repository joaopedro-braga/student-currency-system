...
import com.lds.student_currency_system.application.domain.service.impl.UserServiceImpl;
...
class UserServiceTest {
    ...
    void findAll() {
        ...
        userList.add(new User("Test User 1", "test1@email.com", "password") {});
        userList.add(new User("Test User 2", "test2@email.com", "password") {});
    ...
    void update() {
        Long id = 1L;
        User user = new User("Test User Updated", "test@email.com", "password") {};
        user.setId(id);
